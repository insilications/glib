...
Source0  : https://download.gnome.org/sources/glib/2.62/glib-2.62.5.tar.xz
...
%prep
%setup -q -n glib-2.62.5
cd %{_builddir}/glib-2.62.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582147377
...
cp %{_builddir}/glib-2.62.5/COPYING %{buildroot}/usr/share/package-licenses/glib/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/glib-2.62.5/gmodule/COPYING %{buildroot}/usr/share/package-licenses/glib/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
...
/usr/share/gdb/auto-load/usr/lib32/libglib-2.0.so.0.6200.5-gdb.py
/usr/share/gdb/auto-load/usr/lib32/libgobject-2.0.so.0.6200.5-gdb.py
/usr/share/gdb/auto-load/usr/lib64/libglib-2.0.so.0.6200.5-gdb.py
/usr/share/gdb/auto-load/usr/lib64/libgobject-2.0.so.0.6200.5-gdb.py
...
/usr/lib64/libgobject-2.0.so.0.6200.5
/usr/lib64/libgthread-2.0.so.0
/usr/lib64/libgthread-2.0.so.0.6200.5

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgio-2.0.so.0
/usr/lib32/libgio-2.0.so.0.6200.5
/usr/lib32/libglib-2.0.so.0
/usr/lib32/libglib-2.0.so.0.6200.5
/usr/lib32/libgmodule-2.0.so.0
/usr/lib32/libgmodule-2.0.so.0.6200.5
/usr/lib32/libgobject-2.0.so.0
/usr/lib32/libgobject-2.0.so.0.6200.5
/usr/lib32/libgthread-2.0.so.0
/usr/lib32/libgthread-2.0.so.0.6200.5
